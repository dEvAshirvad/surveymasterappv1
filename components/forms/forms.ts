    ...
    order: [
        ...
        questions: [
            {
                qid: "A1.0",
                title: {
                  en: "Distance from nearest mine (in km)?",
                  hi: "निकटतम खनिज स्थल से दूरी (किमी में)?",
                },
                type: "options",
                uom: { en: "km", hi: "किमी" },
                options: [
                  { value: "10", label: { en: "<10 km", hi: "<10 किमी" } },
                  { value: "20", label: { en: "<20 km", hi: "<20 किमी" } },
                  { value: "30", label: { en: "<30 km", hi: "<30 किमी" } },
                  { value: "40", label: { en: "<40 km", hi: "<40 किमी" } },
                  { value: "50", label: { en: "<50 km", hi: "<50 किमी" } },
                ],
                dmfEligible: {
                  en: "Mining-related",
                  hi: "खनन संबंधी",
      ...
      },
      {
        ...
        questions: [
          ...
          {
            qid: "A3.2",
            title: { en: "Months and estimated monthly cost", hi: "महीने और अनुमानित मासिक लागत" },
            type: "text",
            uom: { en: "Months; Rs./month", hi: "महीने; रुपये/माह" },
            parentId: "A3.1",
            triggerValue: "Yes",
          },
          {
    ...
    order: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            type: "text",
            uom: { en: "Disease types; Cases (approx.)", hi: "रोग प्रकार; अनुमानित मामले" },
            parentId: null,
          },
          {
            qid: "B1.5",
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            type: "time",
            uom: { en: "Time (hrs:min)", hi: "समय (घंटे:मिनट)" },
            parentId: null,
          },
        ],
      },
        ...
        questions: [
          {
            qid: "D1.1",
            title: {
              en: "Are there schools in the village?",
              hi: "क्या गांव में विद्यालय हैं?",
            },
            type: "conditional_options",
            uom: { en: "Yes/No; Type or Distance", hi: "हां/नहीं; प्रकार या दूरी" },
            options: yesNo,
            conditionalRules: [
              {
                triggerValue: "Yes",
                detailLabel: { en: "School type", hi: "विद्यालय प्रकार" },
                detail: {
                  mode: "single",
                  options: [
              ...
              {
                triggerValue: "No",
                detailLabel: { en: "Distance from nearest village (km)", hi: "निकटतम गांव से दूरी (किमी)" },
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            uom: { en: "Yes/No; Distance (km) if No", hi: "हां/नहीं; दूरी (किमी) यदि नहीं" },
            facilities: [
              { key: "Malnutrition", label: { en: "Child malnutrition", hi: "बाल कुपोषण" } },
              { key: "Stunting", label: { en: "Stunting", hi: "स्टंटिंग" } },
              { key: "Wasting", label: { en: "Wasting", hi: "वेस्टिंग" } },
            ],
            parentId: null,
          },
        ],
        ...
        questions: [
          ...
          },
          {
            ...
            conditionalRules: [
              {
                triggerValue: "Yes",
                detailLabel: { en: "Coverage %", hi: "कवरेज %" },
                detail: { mode: "text", placeholder: "Enter coverage percentage" },
              },
            ],
            parentId: null,
          },
            ...
            conditionalRules: [
              {
                ...
                detail: { mode: "text", placeholder: "Enter distance" },
              },
            ],
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            type: "text",
            uom: { en: "Distance (km); Frequency", hi: "दूरी (किमी); आवृत्ति" },
          ...
          },
          {
            ...
            conditionalRules: [
              {
                triggerValue: "Yes",
                detailLabel: { en: "Type and no. of cases", hi: "प्रकार और मामलों की संख्या" },
                detail: { mode: "text", placeholder: "Accident/dust/chemical — enter count" },
              },
            ],
          ...
          },
          {
            qid: "F2.5",
            title: {
              en: "Requirement matrix — assistive devices & welfare programmes for aged/differently abled",
              hi: "आवश्यकता मैट्रिक्स — सहायक उपकरण एवं वृद्ध/दिव्यांग कल्याण कार्यक्रम",
            },
            type: "small_matrix",
            uom: { en: "Required (nos); Est. cost (₹ lakh)", hi: "आवश्यक (संख्या); अनुमानित लागत (₹ लाख)" },
            dmfEligible: { en: "Medical support — differently abled", hi: "चिकित्सा सहायता — दिव्यांग" },
            parentId: null,
            matrixRows: [
              { value: "Wheelchairs", label: { en: "Wheelchairs", hi: "व्हीलचेयर" } },
              { value: "HearingAids", label: { en: "Hearing aids", hi: "श्रवण यंत्र" } },
              { value: "Crutches", label: { en: "Crutches", hi: "बैसाखी" } },
              { value: "WellnessProgram", label: { en: "Wellness program", hi: "कल्याण कार्यक्रम" } },
            ],
            matrixCols: requirementMatrixCols,
          },
        ],
      },
    ],
    ...
    order: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            type: "text",
            uom: { en: "No. of SHGs; Members; Sector", hi: "SHG संख्या; सदस्य; क्षेत्र" },
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            type: "conditional_options",
            uom: { en: "Yes/No; Type; Market access", hi: "हां/नहीं; प्रकार; बाज़ार पहुंच" },
            options: yesNo,
            conditionalRules: [
              {
                triggerValue: "Yes",
                detailLabel: { en: "Type and market access", hi: "प्रकार और बाज़ार पहुंच" },
                detail: { mode: "text", placeholder: "Craft type — market access yes/no" },
              },
            ],
    ...
    order: [
      ...
      },
      {
        ...
        questions: [
          ...
          {
            qid: "H3.3",
            title: { en: "No. of community/public toilet complexes and status", hi: "सामुदायिक/सार्वजनिक शौचालय परिसर और स्थिति" },
            type: "text",
            uom: { en: "No.; Locations; Status", hi: "संख्या; स्थान; स्थिति" },
            dmfEligible: { en: "Provision of toilets", hi: "शौचालय प्रावधान" },
            parentId: null,
          },
          {
          ...
          {
            qid: "H3.5",
            title: { en: "Estimated project cost for sanitation gap filling", hi: "स्वच्छता गैप-फिलिंग हेतु अनुमानित परियोजना लागत" },
            type: "number",
            uom: { en: "Rs. Lakh", hi: "लाख रुपये" },
            dmfEligible: { en: "DMFT sanitation investment", hi: "डीएमएफटी स्वच्छता निवेश" },
            parentId: null,
          },
        ],
      },
        ...
        questions: [
          {
            ...
            type: "text",
            uom: { en: "Ha; Irrigated/Rainfed/Fallow", hi: "हेक्टेयर; सिंचित/वर्षा-आश्रित/परती" },
            parentId: null,
          },
          {
            qid: "J1.2",
            ...
            type: "text",
            uom: { en: "Crop types by season", hi: "मौसम अनुसार फसल प्रकार" },
            parentId: null,
          },
          {
            qid: "J1.3",
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            type: "conditional_options",
            uom: { en: "Yes/No; Type; Distance", hi: "हां/नहीं; प्रकार; दूरी" },
            options: yesNo,
            conditionalRules: [{ triggerValue: "Yes", detailLabel: { en: "Type and distance", hi: "प्रकार और दूरी" }, detail: { mode: "text", placeholder: "Dal mill/oil mill/rice mill etc." } }],
          ...
          },
          {
            ...
            type: "conditional_options",
            uom: { en: "Yes/No; Distance; Capacity", hi: "हां/नहीं; दूरी; क्षमता" },
            options: yesNo,
            conditionalRules: [{ triggerValue: "Yes", detailLabel: { en: "Distance and capacity", hi: "दूरी और क्षमता" }, detail: { mode: "text", placeholder: "Enter details" } }],
          ...
          },
          {
            ...
            type: "conditional_options",
            uom: { en: "Yes/No; Distance; Frequency", hi: "हां/नहीं; दूरी; आवृत्ति" },
            options: yesNo,
            conditionalRules: [{ triggerValue: "Yes", detailLabel: { en: "Distance and frequency", hi: "दूरी और आवृत्ति" }, detail: { mode: "text", placeholder: "Enter details" } }],
    ...
    order: [
      ...
      },
      {
        ...
        questions: [
          ...
          {
            qid: "K3.3",
            title: { en: "Requirement matrix — animal husbandry support needs", hi: "आवश्यकता मैट्रिक्स — पशुपालन सहायता आवश्यकताएं" },
            type: "small_matrix",
            uom: { en: "Required; Est. cost (₹ lakh)", hi: "आवश्यक; अनुमानित लागत (₹ लाख)" },
        ...
        questions: [
          {
            ...
            parentId: null,
            matrixRows: [
              { value: "A", label: { en: "A. Drinking Water", hi: "A. पेयजल" } },
              { value: "B", label: { en: "B. Environment & Pollution", hi: "B. पर्यावरण एवं प्रदूषण" } },
              { value: "C", label: { en: "C. Health Care", hi: "C. स्वास्थ्य" } },
              { value: "D", label: { en: "D. Education", hi: "D. शिक्षा" } },
              { value: "E", label: { en: "E. Women & Children", hi: "E. महिलाएं एवं बच्चे" } },
              { value: "F", label: { en: "F. Aged & Differently Abled", hi: "F. वृद्ध एवं दिव्यांग" } },
              { value: "G", label: { en: "G. Skill Dev. & Livelihood", hi: "G. कौशल एवं आजीविका" } },
              { value: "H", label: { en: "H. Sanitation", hi: "H. स्वच्छता" } },
              { value: "I", label: { en: "I. Housing", hi: "I. आवास" } },
              { value: "J", label: { en: "J. Agriculture", hi: "J. कृषि" } },
              { value: "K", label: { en: "K. Animal Husbandry", hi: "K. पशुपालन" } },
              { value: "L", label: { en: "L. Physical Infrastructure", hi: "L. भौतिक अवसंरचना" } },
              { value: "M", label: { en: "M. Irrigation", hi: "M. सिंचाई" } },
              { value: "N", label: { en: "N. Energy & Watershed", hi: "N. ऊर्जा एवं जलागम" } },
            ],
            matrixCols: [
              { value: "KeyGap", label: { en: "Key Gap Identified", hi: "पहचाना गया प्रमुख गैप" }, inputType: "text" },
              { value: "Priority", label: { en: "Priority (H/M/L)", hi: "प्राथमिकता (H/M/L)" }, inputType: "text" },
              { value: "ExistingCoverage", label: { en: "Existing Scheme Coverage", hi: "मौजूदा योजना कवरेज" }, inputType: "text" },
              { value: "ResidualGap", label: { en: "Residual Gap for DMFT (Rs. Lakh)", hi: "DMFT हेतु शेष गैप (लाख रुपये)" }, inputType: "text" },
